...
# ``mlops_employbridge_project1/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_employbridge_project1-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.mlops_employbridge_project1.mlops_employbridge_project1-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_employbridge_project1.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_employbridge_project1.trip_dropoff_features",
